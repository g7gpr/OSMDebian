...
sudo apt -qq update 
sudo apt -qq upgrade
echo "Install dependancies Part 1/6"
apt-get install -qq git postgresql postgresql-contrib postgis postgresql-11-postgis-2.5 osm2pgsql
echo "Install dependancies Part 2/6"
apt-get install -qq autoconf libtool libmapnik-dev apache2-dev psmisc
echo "Install dependancies Part 3/6"
...
sudo -u postgres -i -- sh -c "osm2pgsql --slim -d gis --hstore --multi-geometry --number-processes 10 --tag-transform-script /home/osm/openstreetmap-carto/openstreetmap-carto.lua --style /home/osm/openstreetmap-carto/openstreetmap-carto.style -C 1000 /home/osm/australia-latest.osm.pbf"
